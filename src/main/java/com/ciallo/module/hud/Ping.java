...
public class Ping extends AbstractHudModule implements Listener3 {
    ...
    private String getText() {
        int latency = 0;
        try {
            if (MC.client3.player != null && MC.client3.getConnection() != null) {
                ClientPacketListener connection = MC.client3.getConnection();
                PlayerInfo info = connection.getPlayerInfo(MC.client3.player.getUUID());
                if (info != null) {
